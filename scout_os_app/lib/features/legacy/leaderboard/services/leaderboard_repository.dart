      ...
      if (responseData['success'] == true && responseData['data'] != null) {
        ...
        if (leaderboardData.myRank != null) {
          ...
          if (leaderboardData.myRank!.xp > 0 &&
            ...
            debugPrint(
              '⚠️ [LEADERBOARD_REPO] WARNING: myRank has XP=${leaderboardData.myRank!.xp} but rank=0! Backend should return rank >= 1.',
            );
          }

          // ✅ Validate: rank should be >= 1 if xp > 0
          if (leaderboardData.myRank!.rank < 1 && leaderboardData.myRank!.xp > 0) {
            debugPrint(
              '⚠️ [LEADERBOARD_REPO] WARNING: myRank.rank=${leaderboardData.myRank!.rank} but xp>0! This should not happen.',
            );
          }
        } else {
          debugPrint(

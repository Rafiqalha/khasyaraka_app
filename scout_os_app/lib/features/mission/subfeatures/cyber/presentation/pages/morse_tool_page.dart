...
class _MorseToolPageState extends State<MorseToolPage> with SingleTickerProviderStateMixin {
  // Theme Colors
           ...
           Expanded(
             child: ListView(
               ...
               children: [
                 ...
                 _buildUnifiedCard(
                    isInput: true,
                    title: _isEncodeMode ? "INPUT TEKS (ABC)" : "INPUT MORSE (.-)",
                     ...
                     child: GestureDetector(
                       ...
                       child: Container(
                         ...
                         decoration: BoxDecoration(
                           ...
                           boxShadow: const [
                             BoxShadow(color: _neonGreenDim, offset: Offset(0, 4), blurRadius: 0)
                           ]
                         ),
          ...
          Container(
             ...
             child: TextField(
                ...
                style: isInput || !_isEncodeMode 
                   ? GoogleFonts.fredoka(fontSize: 18, color: _textBlack, fontWeight: FontWeight.normal)
                   // Output Morse uses Monospace but Dark/Black because card is white
                   : GoogleFonts.sourceCodePro(fontSize: 18, color: _textBlack, fontWeight: FontWeight.bold),
             ...
             GestureDetector(
                ...
                child: Container(
                   ...
                   decoration: BoxDecoration(
                      ...
                      boxShadow: [
                         BoxShadow(color: Colors.red.shade900, offset: const Offset(0, 3), blurRadius: 0)
                      ]
                   ),
